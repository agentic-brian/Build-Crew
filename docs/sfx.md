...
Sixteen clips, one for each noise a driveway job really makes, in
`assets/sfx/` (twelve on 2026-09-12; the rebar and the come-along on
2026-09-14, flow "Build Crew site sounds 2", two takes each). Made 2026-09-12 with ElevenLabs (`eleven_text_to_sound_v2`,
...
| `reversebeep` | 4 | ✓ | the tipper's and the mixer's REVERSE leg into the site (`SiteMain.bring_machine`, 2026-09-15; the skid steer drives in forwards and has none) | a heavy truck reversing alarm: steady evenly spaced electronic beeps, beep beep beep, outdoors, no engine, no voices |
